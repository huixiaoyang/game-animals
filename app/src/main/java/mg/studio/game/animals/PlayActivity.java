...
public class PlayActivity extends AppCompatActivity {
    ...
    public void btnClick(View view) {
        ...
        if (animalToFind.equals(nameOfImagesUsed.get(Integer.valueOf(view.getTag().toString())))) {
            ...
            final ImageView image_correct=(ImageView)findViewById(R.id.image_correct);
            image_correct.setVisibility(View.VISIBLE);
            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
                    image_correct.setVisibility(View.INVISIBLE);
                }
            },500);
            ...
            text_score.getText().toString();
            int score=Integer.parseInt(text_score.getText().toString())+1;
            ...
            if(score==7)
                ...
                startActivity(new Intent(PlayActivity.this, CongratulateActivity.class));
